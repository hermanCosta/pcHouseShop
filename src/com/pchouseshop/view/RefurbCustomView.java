...
public class RefurbCustomView extends javax.swing.JInternalFrame {
    ...
    private void loadRefurbListTable() {
        this._listRefurb = this._refurbController.getAllCustomRefurbController(CommonSetting.COMPANY.getIdCompany());
    ...
    private Refurb getRefurbFields() {
        ...
        if (this.txt_category.getText().trim().isEmpty()
            ...
            JOptionPane.showMessageDialog(this, "Please, enter title and value for custom fields ", "Refurb Product", JOptionPane.ERROR_MESSAGE);
            return getRefurb;
        } else {

            getRefurb = new Refurb(
                    this.txt_category.getText().toUpperCase(),
    ...
    private void searchRefurbByCategory(String pSearch) {
        if (!pSearch.trim().isEmpty()) {
            _listRefurb = _refurbController.searchCustomRefurbConstroller(CommonSetting.COMPANY.getIdCompany(), pSearch);
    ...
    private void initComponents() {
        ...
        lbl_category_star = new javax.swing.JLabel();
        ...
        table_view_refurb.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Hdn_Id", "Category", "Brand", "Model", "Qty", "Price", "Notes"
            }
        ) {
        ...
        if (table_view_refurb.getColumnModel().getColumnCount() > 0) {
            ...
            table_view_refurb.getColumnModel().getColumn(1).setPreferredWidth(100);
            table_view_refurb.getColumnModel().getColumn(1).setMaxWidth(200);
            table_view_refurb.getColumnModel().getColumn(2).setPreferredWidth(200);
            table_view_refurb.getColumnModel().getColumn(2).setMaxWidth(200);
            table_view_refurb.getColumnModel().getColumn(3).setPreferredWidth(250);
            table_view_refurb.getColumnModel().getColumn(3).setMaxWidth(300);
            table_view_refurb.getColumnModel().getColumn(4).setPreferredWidth(50);
            table_view_refurb.getColumnModel().getColumn(4).setMaxWidth(150);
            table_view_refurb.getColumnModel().getColumn(5).setPreferredWidth(100);
            table_view_refurb.getColumnModel().getColumn(5).setMaxWidth(150);
        }
        ...
        lbl_category_star.setFont(new java.awt.Font("Lucida Grande", 1, 16)); // NOI18N
        lbl_category_star.setForeground(java.awt.Color.red);
        lbl_category_star.setText("*");

        lbl_category.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        lbl_category.setText("Category");

        txt_category.setMinimumSize(new java.awt.Dimension(12, 20));
        txt_category.setPreferredSize(new java.awt.Dimension(0, 25));
                ...
                .addGroup(panel_refurb_basic_infoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panel_refurb_basic_infoLayout.createSequentialGroup()
                        .addGroup(panel_refurb_basic_infoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(panel_refurb_basic_infoLayout.createSequentialGroup()
                                .addComponent(lbl_category_star)
                                .addGap(5, 5, 5)
                                .addComponent(lbl_category)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txt_category, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        panel_refurb_basic_infoLayout.setVerticalGroup(
            ...
            .addGroup(panel_refurb_basic_infoLayout.createSequentialGroup()
                ...
                .addGroup(panel_refurb_basic_infoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(lbl_category)
                    .addComponent(lbl_category_star, javax.swing.GroupLayout.PREFERRED_SIZE, 12, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panel_refurb_basic_infoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private javax.swing.JLabel lbl_category_star;
